...
| [詳細設計書](detailed-design.md) | 開発、アーキテクト、QA | v4 domain、AI operation、formula、checkpoint、UI、Windows配布設計 |
...
| [要求定義書](../../docs/requirements-definition.md) | 要求所有者、QA | v4.1規範baseline |
...
ADR-0012はADR-0011のv3評価契約をsupersedeし、入力不変、closed AI result、Excel formula ownership、2-project構成等をcarry forwardします。ADR-0013はADR-0012のplatform配布だけをWindows 11 x64初版へ限定します。ADR-0014は製品SemVerとrelease identityを定義します。ADR-0001〜0012のsuperseded箇所と旧baseline／preflightは履歴として保持します。
...
flowchart LR
    ...
    V41 --> IMPL[current source + deterministic tests]
...
3. current requirements v4.1 / ADR-0012 / ADR-0013 / ADR-0014 / detailed design / version-management
...
|---|---:|---|
| Product version | `1.0.0` | [`Directory.Build.props`](../../Directory.Build.props)、[版管理手順](version-management.md) |
